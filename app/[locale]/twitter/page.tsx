    ...
    <div className="relative pt-20 base:pt-48 ">
      ...
      <h2 className="text-lg font-bold leading-6 base:leading-9 base:text-[32px] mx-auto mb-3 base:mb-14 text-center max-w-80 base:max-w-[857px]">
        ...
        <div className="mb-7 base:mb:24">
          <div className="">
            ...
            <p className="text-xs max-w-[644px] base:max-w-full mx-auto base:text-2xl">{t("how-fast-download-text3")}</p>
          </div>
        </div>
      ...
      <div className="max-w-[368px] flex flex-col items-center base:items-start base:max-w-[496px] w-full  h-full max-h-[392px] base:max-h-[596px] mb-7 base:mb-14">
        ...
        <div className="flex flex-col mb-7 base:mb-14">
          <p className="mb-3 base:mb-6 text-xs base:text-2xl">{t("how-download-phone-text1")}</p>
          <p className="mb-3 base:mb-6 text-xs base:text-2xl">{t("how-download-phone-text2")}</p>
        </div>
      ...
      <div className="flex base:justify-between flex-col items-center base:flex-row base:items-start mb-7 base:mb-14">
          <div className="w-full base:w-9/12">
            ...
            <h3 className="text-[13px] base:text-2xl font-bold text">{t("how-download-android-title")}</h3>
            <p className="text-xs base:text-2xl mb-3 base:mb-6">{t("how-download-android-text1")}</p>
            <p className="text-xs base:text-2xl mb-3 base:mb-0">{t("how-download-android-text2")}</p>
          </div>
      ...
      <div className="flex base:justify-between flex-col-reverse items-center base:flex-row base:items-start mb-7 base:mb-14">
          ...
          <div className="w-full base:w-9/12">
            ...
            <h3 className="text-[13px] base:text-2xl font-bold text">{t("how-download-ios-title")}</h3>
            <p className="text-xs base:text-2xl">{t("how-download-ios-text1")}</p>
            <ul className="list-disc pl-5 base:mb-6 mb-3 ">
              <li className="text-xs base:text-2xl">{t("how-download-ios-item1")}</li>
              <li className="text-xs base:text-2xl">{t("how-download-ios-item2")}</li>
            </ul>
