...
const Header = async ({ params }: { params: Params }) => {
  ...
  return (
    <TranslationsProvider
      ...
      resources={resources}
    >
      <header className="w-full px-5 h-20 flex items-center absolute z-50 bg-white">
        <div className="flex items-center max-w-lg mx-auto  w-full justify-between ">
          <div className="z-20 relative w-28 md:w-52">
            <Link href={"/"}>
              <svg
              ...
              >
                ...
                />
                <path
                  d="M0 37.6559H4.21025V33.7884H0V37.6559Z"
                  fill="#1C1917"
                />
                <path
          ...
          <nav className="base:flex hidden z-20 relative">
